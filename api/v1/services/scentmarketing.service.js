...
const { ScentMarketing } = require('../db/models');
...
const ScentMarketingService = {
  async createScentMarketing(data) {
    try {
      ...
      const scentMarketing = new ScentMarketing(data);
      await scentMarketing.save();
      return scentMarketing;
    } catch (error) {
...
module.exports = ScentMarketingService;